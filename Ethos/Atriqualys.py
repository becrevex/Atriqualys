...
def console():
	#os.system("cls")
	global qualys, atrium
	qualys = QualysAccess.Assets('pbm')
	atrium = AtriumASD.ASD("./Atrium ASD Application Information 10-18-16.xlsx")
...
if __name__=='__main__':
	...
	try:
		...
		print "Usage: ./Atriqualys.py [Atrium ASD Application Information X-XX-XX.xlsx]"
		print "\n(or load it in the Interpreter)."
		sys.exit()
	print "Loading ASD File Content..."
	print "Loading Qualys Assets..."
	qualys = QualysAccess.Assets()
